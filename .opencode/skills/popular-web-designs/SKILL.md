...
description: >
  54 production-quality design systems extracted from real websites (Stripe,
  Linear, Vercel, Notion, Airbnb, …). Load a template to generate HTML/CSS
  matching a target site's visual identity — colors, typography, components,
  layout rules. Triggers: /popular-web-designs, "looks like stripe", "design
  like linear", "vercel style", landing page, dashboard design.
---
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Font Substitution Notes -->
